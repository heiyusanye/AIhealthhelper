<template>
    <div class="container">
        ...
        <div class="form-container">
            <el-form label-position="top" :model="formData" ref="submitFormRef" :rules="rules" label-width="120px">
                ...
                <el-form-item label="确认密码" prop="confirmPassword">
                    <el-input v-model="formData.confirmPassword" placeholder="请确认密码" size="large" />
                </el-form-item>
                <el-form-item>
                    <el-button class="btn" type="primary" @click="handleRegister(submitFormRef)">注册</el-button>
                </el-form-item>
            </el-form>
        </div>
    </div>
