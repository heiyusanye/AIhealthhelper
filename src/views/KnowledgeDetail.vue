        ...
        <div class="content">
            <div class="diary-card">
                ...
                <div class="sub-title">
                    ...
                    <div class="flex-box">
                        ...
                        <span>{{ dayjs(articleDetail.createdAt).format('YYYY-MM-DD HH:mm:ss') }}</span>
                    </div>
                </div>
                ...
                <div class="flex-box">
                    <div style="margin-top: 20px;" class="item flex-box">
                        <el-icon>
                            <Avatar />
                        </el-icon>
            ...
            <div class="diary-card">
                ...
                <div class="tags-content" v-if="articleDetail.tagArray && articleDetail.tagArray.length > 0">
                    ...
                    <div class="tags-list">
                        <el-tag v-for="tag in articleDetail.tagArray" :key="tag" effect="light" size="large"
                            class="tag-tag">{{ tag }}</el-tag>
                    </div>
                </div>
            </div>
        </div>
...
import { List, Platform, Avatar } from '@element-plus/icons-vue'
