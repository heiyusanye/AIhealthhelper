    ...
    <div class="consultation-record">
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column label="操作" width="100">
                <template #default="scope">
                    <el-button type="primary" text @click="viewSessionDetail(scope.row)" size="mini">查看详情</el-button>
                </template>
            </el-table-column>
        </el-table>
        <el-pagination layout="prev, pager, next" :total="pagination.total" :page-size="pagination.size"
            @change="handleChange" style="margin-top: 25px;" />
                    ...
                    <div class="messages-list" v-loading="loadingMessage">
                        <div v-for="message in sessionMessages" :key="message.id" class="message-item"
                            ...
                            <div class="message-header">
                                ...
                                <div class="timer">{{ message.createdAt }}</div>
                            </div>
...
import { getConsultationRecordPage, getConsultationRecordDetail } from '@/api/admin'
const tableData = ref([])
...
const handleSearch = () => {
    getConsultationRecordPage(pagination).then(res => {
...
const viewSessionDetail = (row) => {
    ...
    getConsultationRecordDetail(row.id).then(res => {
