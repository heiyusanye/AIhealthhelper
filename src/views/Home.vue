        ...
        <div class="content">
            <div class="text">
                ...
                <div class="hero-actions">
                    ...
                    <el-button style="border-color: #fff;" color="transparent" size="large">记录心情，释放情感</el-button>
                </div>
            </div>
            <div class="robot">
                <el-image :src="robotUrl" style="width: 150px; height: 150px;" alt="robot" fit="contain" />
            </div>
...
<script setup>
import { ref } from 'vue'
const robotUrl = new URL('@/assets/images/robot-fill.png', import.meta.url).toString()
